const data = {
  ...
  beans:{
    Sumatra:{
      name: "Sumatra",
      tagline: "Coffee from the Island of Gold.",
      ...
      background: "sumatra-bckgd.jpg",
      image: "sumatra.jpg"
    },

    Columbia:{
      name: "Columbia",
      tagline: "The Coffee for Families.",
      ...
      background: "columbia-bckgd.jpg",
      image: "columbia.jpg"
    },

    Guatemala:{
      name: "Guatemala",
      tagline: "Top Coffee Producer.",
      ...
      background: "guatemala-bckgd.jpg",
      image: "guatemala.jpg"
    },

    Yemen:{
      name: "Yemen",
      tagline: "The original Coffee Bean.",
